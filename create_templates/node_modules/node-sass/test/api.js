...
describe('api', function() {
  ...
  describe('.render(options, callback)', function() {
    ...
    it('should render with indentWidth and indentType options', function(done) {
      sass.render({
        data: 'p { color: transparent; }',
        indentWidth: 7,
        indentType: 'tab'
      }, function(error, result) {
        assert.strictEqual(result.css.toString().trim(), 'p {\n\t\t\t\t\t\t\tcolor: transparent; }');
        done();
      });
    });
  ...
  describe('.render(functions)', function() {
    ...
    it('should let custom functions call setter methods on wrapped sass values (number)', function(done) {
      sass.render({
        data: 'p { width: foo(42px); height: bar(42px); }',
        functions: {
          'foo($a)': function(size) {
            size.setUnit('rem');
            return size;
    ...
    it('should properly convert colors when calling custom functions', function(done) {
      sass.render({
        data: 'p { color: foo(#f00); background-color: bar(); border-color: baz(); }',
        functions: {
    ...
    it('should properly convert boolean when calling custom functions', function(done) {
      sass.render({
        data: 'p { color: if(foo(true, false), #fff, #000);' +
    ...
    it('should let custom functions call setter methods on wrapped sass values (boolean)', function(done) {
      sass.render({
        data: 'p { color: if(foo(false), #fff, #000); background-color: if(foo(true), #fff, #000); }',
        functions: {
          'foo($a)': function(a) {
    ...
    it('should properly convert maps when calling custom functions', function(done) {
      sass.render({
        data: '$test-map: foo((abc: 123, #def: true)); p { color: if(map-has-key($test-map, hello), #fff, #000); }' +
    ...
    it('should properly convert null when calling custom functions', function(done) {
      sass.render({
        data: 'p { color: if(foo("bar"), #fff, #000); } ' +
    ...
    it('should be possible to carry sass values across different renders', function(done) {
      ...
      sass.render({
        data: 'p { color: foo((abc: #112233, #ddeeff: true)); }',
        functions: {
          foo: function(m) {
            persistentMap = m;
        ...
        sass.render({
          data: 'p { color: map-get(bar(), abc); background-color: baz(); }',
          functions: {
            bar: function() {
    ...
    it('should always map null, true and false to the same (immutable) object', function(done) {
      ...
      sass.render({
        data: 'p { color: foo(bar(null)); background-color: baz("foo" == "bar"); }',
        functions: {
          foo: function(a) {
